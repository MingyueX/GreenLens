...
global rgb_quality_ratio, depth, bgr, new_height, new_width, filter_img


def preprocess_images(depth_arr, rgb_arr):
    global rgb_quality_ratio,depth, bgr, new_height, new_width, filter_img
    ...
    filter_img = filter_depth_img_with_centralpixel(depth, hull_img)

    image_rgb = Image.fromarray(cv2.cvtColor(bgr, cv2.COLOR_BGR2RGB))
    img_depth = Image.fromarray(filter_img)
...
def run(output_array, gt_width, gt_height, GAMMA = 371.25):
    ...
    res = res * 255
    res_bas64 = numpy_array_to_base64(res)
    ######## Inference over ########
    res = prediction_preprocess(res)
    res_new_base64 = numpy_array_to_base64(res)
    ...
    depth_base64 = numpy_array_to_base64(depth)
    bgr_base64 = numpy_array_to_base64(bgr)
    filter_depth_img_base64 = numpy_array_to_base64(filter_img)
    ...
    result = {
        ...
        "depth": depth_base64,
        "bgr": bgr_base64,
        "filter_depth_img": filter_depth_img_base64,
        "res": res_bas64,
        "res_new": res_new_base64
    }
