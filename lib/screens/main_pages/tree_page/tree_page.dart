...
class TreePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(color: AppColors.lightBackground, child:
        BlocBuilder<TreePageViewModel, TreesState>(builder: (context, state) {
      if (state.plotId == null) {
        return Center(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
                children: [
          Text("No plot yet", style: Theme.of(context).textTheme.bodySmall),
          const SizedBox(height: 10),
          Text("Please add plot first",
              style: Theme.of(context).textTheme.bodySmall),
          const SizedBox(height: 10),
          PlainButton(
              onPressed: () {
                context.read<TabbedPageViewModel>().switchToPage(MainPage.plotPage, context);
        ...
        Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Latest Record", style: Theme.of(context).textTheme.bodyMediumBold,),
                const SizedBox(
                  height: 5,
                ),
                ...
                TwoSegRichText(seg1: "Diameter (m): ", seg2: tree.diameter?.toStringAsFixed(2) ?? "No diameter"),
