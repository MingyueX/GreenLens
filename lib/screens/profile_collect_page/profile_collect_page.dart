                    ...
                    PlatformTextFormField(
                      ...
                      material: (_, __) => MaterialTextFormFieldData(
                        decoration: InputDecoration(
                          ...
                          errorStyle: Theme.of(context).textTheme.labelSmall?.copyWith(color: AppColors.alertRed),
                        ),
                        validator: (value) {
                  ...
                  onPressed: () async {
                    if (_formKey.currentContext != null &&  _formKey.currentState!.validate()) {
                      final Farmer farmer = Farmer(
                          participantId: int.parse(_idController.text), name: "${_firstNameController.text} ${_lastNameController.text}");
                      await Provider.of<FarmerProvider>(context, listen: false).setFarmer(farmer);
